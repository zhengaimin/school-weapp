...
const { currentStudent, students } = storeToRefs(parentStore)
  ...
  >
    <Form :model="formData">
      <view p="4" flex="~ col gap-3">
        <!-- 设备类型选择 -->
        <Cell id="deviceType" label="设备类型" prop="deviceType">
          <Radio v-model="formData.deviceType" :options="DEVICE_TYPE_OPTIONS" :columns="2" />
        </Cell>
