...
// Options
export const PACKAGE_TYPE_OPTIONS: TOptions<TPackageType> = [
...
// I18N
export const PACKAGE_STATUS_I18N: TI18NMap<TPackageStatus> = {
...
// Options
export const PACKAGE_STATUS_OPTIONS: TOptions<TPackageStatus> = [
 ...
 * 状态配置映射
 */
export const PACKAGE_STATUS_CONFIGS: TStatusConfigMap<TPackageStatus> = {
