...
// I18N
export const PAYMENT_METHOD_I18N: Record<TPaymentMethod, string> = {
...
// I18N
export const PAYMENT_STATUS_I18N: Record<TPaymentStatus, string> = {
...
// #region 充值结果状态配置
export const RECHARGE_RESULT_STATUS_CONFIG = {
